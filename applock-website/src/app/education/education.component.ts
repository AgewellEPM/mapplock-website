...
export class EducationComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit() {
    // Set SEO tags for education page
    this.seoService.setEducationPage();
  ...
  initCounterAnimations() {
    ...
    // Start counter animation when elements are visible
    const observer = new IntersectionObserver((entries) => {
      entries.forEach(entry => {
        if (entry.isIntersecting) {
          animateCounters();
  ...
  navigateToDemo() {
    console.log('🚀 Starting MappLock Demo from Education...');
  ...
  startFreeTrial() {
    console.log('🚀 Starting Free Trial Demo from Education...');
    this.openDemoBrowser();
  }

  scheduleDemo() {
    console.log('📞 Starting Schedule Demo from Education...');
    this.openDemoBrowser();
  }
